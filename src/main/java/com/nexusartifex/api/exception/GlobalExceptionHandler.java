...
public class GlobalExceptionHandler {
        ...
        private static final String CODE_CONFLICT_OPERATION = "CONFLICT_OPERATION";
        ...
        public ResponseEntity<ErrorResponse> handleInvalidEvolution(
                ...
                return ResponseEntity
                                .status(HttpStatus.BAD_REQUEST)
                                .body(ErrorResponse.of(CODE_INVALID_EVOLUTION, ex.getMessage(),
        ...
        public ResponseEntity<ErrorResponse> handleInvalidGraphOperation(
                ...
                return ResponseEntity
                                .status(HttpStatus.BAD_REQUEST)
                                .body(ErrorResponse.of(CODE_INVALID_GRAPH_OPERATION, ex.getMessage(),
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<ErrorResponse> handleProjectNotFound(
                ...
                return ResponseEntity
                                ...
                                .body(ErrorResponse.of(CODE_PROJECT_NOT_FOUND, ex.getMessage(),
                                                request.getRequestURI()));
        }
        ...
        public ResponseEntity<ErrorResponse> handleConflict(
                        ConflictOperationException ex, HttpServletRequest request) {
                return ResponseEntity
                                .status(HttpStatus.CONFLICT)
                                .body(ErrorResponse.of(CODE_CONFLICT_OPERATION, ex.getMessage(),
                                                request.getRequestURI()));
        }
}
